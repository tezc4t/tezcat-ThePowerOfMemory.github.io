...
<body>
    <div class="all" >
        ...
        <div class="container" ><!---define the container class for the first div--->
            ...
            <a id="mdpo" href="My Account.html">mot de passe oublié?</a><!---redirection for MyAccount.html(renitalisation) page--->
            ...
            <figcaption id="pasdecompte"> pas de compte? <a href="inscription.html" id="create">je m'inscris</a></figcaption>
