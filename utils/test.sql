...
VALUES
    ('tezcat','tezcat.auguste@gmail.com','tezcat'),
...
INSERT INTO jeu (id, nom_du_jeu)
VALUES (1, 'Power Of Memory');
...
VALUES
    (1,1,'salut à tous c’est ma 1re fois ici, qlq1 pour une partie ?'),
...
SELECT nom_du_jeu, score.user_id, difficulty, score.score, score.created_at
FROM score 
JOIN utilisateur ON score.user_id = utilisateur.id
JOIN jeu ON jeu.id = score.game_id
ORDER BY difficulty, score.score;
