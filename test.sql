...
INSERT INTO utilisateur (Pseudo, EMAIL, MDP)
VALUES('maxatlas','max@pilato.fr','HDue98è§!98K');
INSERT INTO utilisateur (Pseudo, EMAIL, MDP)
VALUES('Nathev','nahtan.blabla@truc.fr','KhbkuhIH!8');
INSERT INTO utilisateur (Pseudo, EMAIL, MDP)
VALUES('Thomas','tomas.blublu@truc.fr','krj7§IjIJ8K');
INSERT INTO utilisateur (Pseudo, EMAIL, MDP)
VALUES('Random','random.random@truc.fr','sjhfsIHO87§6');
--FIN utilisateurs--
--jeu--
